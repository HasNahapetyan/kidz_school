!function (r) {
    ...
    r(window).on("load", function () {
        ...
        var t = r(".header"), a = t.find(".navbar"), o = 0, s = r(".navbar-sticky");
        r(window).scroll(function () {
            var e = r(this).scrollTop();
            o < e ? s.addClass("navbar-scrollUp") : s.removeClass("navbar-scrollUp"), o = e, a.hasClass("navbar-sticky") && (r(this).scrollTop() <= 600 || r(this).width() <= 300) ? (a.removeClass("navbar-scrollUp"), a.removeClass("navbar-sticky").appendTo(t), t.css("height", "auto")) : !a.hasClass("navbar-sticky") && 300 < r(this).width() && 600 < r(this).scrollTop() && (t.css("height", t.height()), a.addClass("navbar-scrollUp"), a.css({opacity: "0"}).addClass("navbar-sticky"), a.appendTo(r("body")).animate({opacity: 1}))
        }), r(window).trigger("resize"), r(window).trigger("scroll")
    }), 991 < r(window).width() && r(".navbar-expand-lg .navbar-nav .dropdown").hover(function () {
        r(this).addClass("").find(".dropdown-menu").addClass("show")
    }, function () {
        r(this).find(".dropdown-menu").removeClass("show")
    }), 767 < r(window).width() && r(".navbar-expand-md .navbar-nav .dropdown").hover(function () {
        r(this).addClass("").find(".dropdown-menu").addClass("show")
    }, function () {
        r(this).find(".dropdown-menu").removeClass("show")
    }), 0 !== r("#rev_slider_1").length && r("#rev_slider_1").show().revolution({
        delay: 5e3,
        ...
        navigation: {
            arrows: {enable: !0, style: "hesperiden", hide_onleave: !1},
            bullets: {
                enable: !1,
                style: "hesperiden",
                hide_onleave: !1,
    ...
    }), 0 !== r("#rev_slider_custom_2").length && r("#rev_slider_custom_2").show().revolution({
        delay: 5e3,
        sliderLayout: "fullwidth",
        sliderType: "standard",
        responsiveLevels: [1171, 1025, 769, 480],
        ...
        disableProgressBar: "on"
    }), 0 !== r("#rev_slider_custom_3").length && r("#rev_slider_custom_3").show().revolution({
        delay: 5e3,
        ...
        disableProgressBar: "on"
    }), 0 !== r("#rev_slider_custom_4").length && r("#rev_slider_custom_4").show().revolution({
        delay: 5e3,
        sliderLayout: "fullwidth",
        sliderType: "standard",
        responsiveLevels: [1171, 1025, 769, 480],
    ...
    0 !== e.length && e.owlCarousel({
        ...
        dots: !1,
        responsiveClass: !0,
        responsive: {0: {items: 1}, 768: {items: 3}, 992: {items: 5}}
    });
    var t = r("#testimonial");
    0 !== t.length && t.owlCarousel({
        loop: !0,
        margin: 30,
        dots: !1,
        nav: !0,
    ...
    0 !== o.length && o.owlCarousel({
        ...
        r(window).scroll(function () {
            100 < r(this).scrollTop() ? r("#back-to-top").css({
                opacity: "1",
                visibility: "visible"
            }) : r("#back-to-top").css({opacity: "0", visibility: "hidden"})
        })
    });
    var s = r(".grid");
    0 !== s.length && s.imagesLoaded(function () {
    ...
    0 !== n.length && n.select2({minimumResultsForSearch: -1}), r(".box-video").click(function () {
    ...
    if (c.length) {
        ...
        r(window).scroll(function () {
            ...
            0 === u && r(window).scrollTop() > e && (r(".counter-value").each(function () {
                var e = r(this), t = e.attr("data-count");
                r({countNum: e.text()}).animate({countNum: t}, {
                    duration: 5e3, easing: "swing", step: function () {
    ...
    var h = r(".animated"), p = r(window);
    p.on("scroll resize", function () {
        var e = p.height(), i = p.scrollTop(), n = i + e;
        r.each(h, function () {
            var e = r(this), t = e.outerHeight(), a = e.offset().top, o = a + t, s = r(this).attr("data-animation");
            i <= o && a <= n ? e.addClass(s) : e.removeClass(s)
        })
    }), p.trigger("scroll"), r(".incr-btn").on("click", function (e) {
        var t, a = r(this), o = a.parent().find(".quantity").val();
    ...
    document.getElementById("price-range") && v.noUiSlider.on("update", function (e, t) {
        f[t].innerHTML = "$" + Math.floor(e[t])
    }), (new WOW).init();
    var m = m || [];
    m.push(["_setAccount", "UA-71155940-5"]), m.push(["_trackPageview"]), function () {
